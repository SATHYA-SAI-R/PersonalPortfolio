    ...
    <section id="Home" className={styles.heroContainer}>
      ...
      <div className="z-40 xl:mb-0 mb-[20%]">
        <motion.h1
          ...
          className="text-5xl md:text-7xl lg:text-8xl font-bold z-10 mb-6 pl-10 heroTitle"
        >
        ...
        <motion.p
          ...
          className="text-xl md:text-1xl lg:text-2xl text-purple-200 max-w-2xl pl-10"
        >
      ...
      <Spline
        className="absolute xl:right-[-28%] right-0 top-[-20%] lg:top-0 rotate-185 "
